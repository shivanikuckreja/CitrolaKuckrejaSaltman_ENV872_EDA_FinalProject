...
#1. Play with changing the options on the sidebar. 
    # Choose a shinytheme that you like. The default here is "yeti" - changed to superhero
    # How do you change the default settings? We are able to command what is default by value or select
...
#4. Analyze the similarities and differences between ggplot code for a rendered vs. static plot.
    # Why are the aesthetics for x, y, fill, and shape formatted the way they are? Continuous vs discrete

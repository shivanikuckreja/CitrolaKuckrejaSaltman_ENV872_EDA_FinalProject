...
summary(logit3)
 ...
 summary(GGPlotMortalityBeeFilter$CAS.Number)
 summary(BeeMortalityExposureType$CAS.Number)
...
summary(logit4)
 ...
 summary(GGPlotMortalityNonBeeFilter$CAS.Number)
 summary(NonBeeMortalityExposure$CAS.Number)

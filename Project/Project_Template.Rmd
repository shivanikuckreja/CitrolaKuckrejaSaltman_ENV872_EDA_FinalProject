...
------- | ---------
ECOTOX_Neonicotinoids_Insects | EPA Data observing affects of chemicals and exposure types on insects
\newpage
...
dim(Original_ECOTOX_CSV)
colnames(Original_ECOTOX_CSV)
summary(Original_ECOTOX_CSV)

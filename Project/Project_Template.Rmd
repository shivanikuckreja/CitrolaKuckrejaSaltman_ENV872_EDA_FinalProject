...
Processed1_Filter <- Original_ECOTOX_CSV %>%
  select(Chemical.Name, Species.Common.Name, Organism.Lifestage, Organism.Age, Exposure.Type, Effect, Effect.Measurement) 

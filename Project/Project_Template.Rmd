...
Processed1_Filter <- Original_ECOTOX_CSV %>%
  select( Species.Common.Name, Exposure.Type, Effect) 

# Shivani removed CAS.Number, Chemical.Name,  Organism.Lifestage, Organism.Age, and  Effect.Measurement from the above Processed1_Filter dataset
